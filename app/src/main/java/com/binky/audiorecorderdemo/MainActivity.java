...
import com.binky.audiorecorder.StatusListener;
import com.binky.audiorecorder.utils.Log;
import com.binky.audiorecorderdemo.widget.WaveView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private AudioRecorder idealRecorder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idealRecorder = AudioRecorder.getInstance();
        ...
        recordConfig = new AudioRecorder.RecordConfig(MediaRecorder.AudioSource.MIC, 48000, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT);
